...
const config: OracleConfig = {
  ...
  oraclePackageId: requireEnv('ORACLE_PACKAGE_ID', '0x3cce3ba8eb35dfd1519291b9aeba08a96ebebcdaf0d676dae540a29e7975a7e1'),
  oracleModuleName: process.env.PYTH_ORACLE_MODULE ?? 'pyth_oracle',
